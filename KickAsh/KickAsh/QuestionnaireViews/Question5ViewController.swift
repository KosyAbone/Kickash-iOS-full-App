...
class Question5ViewController: UIViewController {
    ...
    @IBAction func nextQuestion(_ sender: UIButton) {
        if(option1Text.backgroundColor == selectedButtonColor){
            UserDefaults.standard.set(option1Text.titleLabel?.text, forKey: QuestionnaireDataKey.question5 + username)
        }
        else if (option2Text.backgroundColor == selectedButtonColor){
            UserDefaults.standard.set(option2Text.titleLabel?.text, forKey: QuestionnaireDataKey.question5 + username)
        }
        else if (option3Text.backgroundColor == selectedButtonColor){
            UserDefaults.standard.set(option3Text.titleLabel?.text, forKey: QuestionnaireDataKey.question5 + username)
        }
        else {
...
//        let answer = UserDefaults.standard.string(forKey: QuestionnaireDataKey.question5 + username)
//        print(answer)
    }
